...
int main()
{
	...
	while (quit)
	{
		cout << "1.Информация" << endl << "2.Еда и настроение" << endl << "3.Здоровье и спорт" << endl << "4.Бомжатничать и поборы" << endl << "5.Работа" << endl << "6.Учеба" << endl << "7.Недвижимость и транспорт" << endl << "8.Политика" << endl;
		int choice = 0;
		cin >> choice;
		switch (choice)
		{
